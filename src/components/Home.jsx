...
useEffect(() => {
  ...
  // if (isLoading) {
  //   return (
  //     <div className="fixed flex flex-col justify-center items-center h-screen">
  //  <iframe
  ...
  if (isLoading) {
  return (
    <div className="relative w-full min-h-screen overflow-hidden dark:bg-[#050505]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 pt-12 pb-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 mb-10">
          ...
          <Skeleton className="h-20 col-span-2 md:col-span-1 rounded-md" />
          <Skeleton className="h-10 col-span-2 md:col-span-1 rounded-md" />
        </div>

        {/* CarCard skeleton grid */}
        <div className="flex flex-wrap justify-evenly gap-4">
          {Array.from({ length: 9 }).map((_, idx) => (
            <div
              key={idx}
              className="w-full sm:w-[calc(50%-1rem)] lg:w-[calc(33.333%-1rem)] max-w-[350px] rounded-xl shadow-lg bg-white/10 backdrop-blur-md border border-white/10 p-4"
            >
